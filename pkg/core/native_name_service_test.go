...
func TestExpiration(t *testing.T) {
	...
	testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc,
		"setRecord", stackitem.Null{}, "first.com", int64(recordtypes.TXT), "sometext")
	...
	tx, err = prepareContractMethodInvokeGeneric(bc, defaultNameServiceSysfee, bc.contracts.NameService.Hash,
		"getRecord", acc, "first.com", int64(recordtypes.TXT))
	require.NoError(t, err)
...
func TestSetGetRecord(t *testing.T) {
	...
	t.Run("set before register", func(t *testing.T) {
		testNameServiceInvoke(t, bc, "setRecord", nil, "neo.com", int64(recordtypes.TXT), "sometext")
	})
	testNameServiceInvokeAux(t, bc, defaultRegisterSysfee, true, "register",
		true, "neo.com", testchain.CommitteeScriptHash())
	t.Run("invalid parameters", func(t *testing.T) {
		testNameServiceInvoke(t, bc, "setRecord", nil, "neo.com", int64(0xFF), "1.2.3.4")
		testNameServiceInvoke(t, bc, "setRecord", nil, "neo.com", int64(recordtypes.A), "not.an.ip.address")
	})
	t.Run("invalid witness", func(t *testing.T) {
		testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc, "setRecord", nil,
			"neo.com", int64(recordtypes.A), "1.2.3.4")
	})
	testNameServiceInvoke(t, bc, "getRecord", stackitem.Null{}, "neo.com", int64(recordtypes.A))
	testNameServiceInvoke(t, bc, "setRecord", stackitem.Null{}, "neo.com", int64(recordtypes.A), "1.2.3.4")
	testNameServiceInvoke(t, bc, "getRecord", "1.2.3.4", "neo.com", int64(recordtypes.A))
	testNameServiceInvoke(t, bc, "setRecord", stackitem.Null{}, "neo.com", int64(recordtypes.A), "1.2.3.4")
	testNameServiceInvoke(t, bc, "getRecord", "1.2.3.4", "neo.com", int64(recordtypes.A))
	testNameServiceInvoke(t, bc, "setRecord", stackitem.Null{}, "neo.com", int64(recordtypes.AAAA), "2001:0000:1f1f:0000:0000:0100:11a0:addf")
	testNameServiceInvoke(t, bc, "setRecord", stackitem.Null{}, "neo.com", int64(recordtypes.CNAME), "nspcc.ru")
	testNameServiceInvoke(t, bc, "setRecord", stackitem.Null{}, "neo.com", int64(recordtypes.TXT), "sometext")

	// Delete record.
	t.Run("invalid witness", func(t *testing.T) {
		testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc, "setRecord", nil,
			"neo.com", int64(recordtypes.CNAME))
	})
	testNameServiceInvoke(t, bc, "getRecord", "nspcc.ru", "neo.com", int64(recordtypes.CNAME))
	testNameServiceInvoke(t, bc, "deleteRecord", stackitem.Null{}, "neo.com", int64(recordtypes.CNAME))
	testNameServiceInvoke(t, bc, "getRecord", stackitem.Null{}, "neo.com", int64(recordtypes.CNAME))
	testNameServiceInvoke(t, bc, "getRecord", "1.2.3.4", "neo.com", int64(recordtypes.A))
}
...
func TestResolve(t *testing.T) {
	...
	testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc, "setRecord", stackitem.Null{},
		"neo.com", int64(recordtypes.A), "1.2.3.4")
	testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc, "setRecord", stackitem.Null{},
		"neo.com", int64(recordtypes.CNAME), "alias.com")

	testNameServiceInvokeAux(t, bc, defaultRegisterSysfee, acc, "register",
		true, "alias.com", acc.PrivateKey().GetScriptHash())
	testNameServiceInvokeAux(t, bc, defaultNameServiceSysfee, acc, "setRecord", stackitem.Null{},
		"alias.com", int64(recordtypes.TXT), "sometxt")

	testNameServiceInvoke(t, bc, "resolve", "1.2.3.4",
		"neo.com", int64(recordtypes.A))
	...
	testNameServiceInvoke(t, bc, "resolve", stackitem.Null{},
		"neo.com", int64(recordtypes.AAAA))
}
